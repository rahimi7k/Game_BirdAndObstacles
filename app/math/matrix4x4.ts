...
export class Matrix4x4 {
	...
	public static orthographic(left: number, right: number, bottom: number, top: number, near: number, far: number): Matrix4x4 {
		...
		const rl: number = 1.0 / (right - left);
		const bt: number = 1.0 / (top - bottom);
		const nf: number = 1.0 / (far - near);

		const x: number = (right + left) * rl;
		const y: number = (top + bottom) * bt;
		const z: number = (far + near) * nf;

		const zInv: number = - 2 * nf;

		m._data[0] = 2 * rl; m._data[4] = 0; m._data[8] = 0; m._data[12] = - x;
		m._data[1] = 0; m._data[5] = 2 * bt; m._data[9] = 0; m._data[13] = - y;
		m._data[2] = 0; m._data[6] = 0; m._data[10] = zInv; m._data[14] = - z;
		m._data[3] = 0; m._data[7] = 0; m._data[11] = 0; m._data[15] = 1;
	...
	/*public static perspective(fov: number, aspect: number, nearClip: number, farClip: number): Matrix4x4 {
		...
		const rangeInv: number = 1.0 / (nearClip - farClip);
	...
	public static perspective(left: number, right: number, top: number, bottom: number, near: number, far: number): Matrix4x4 {
		...
		m._data[0] = x; m._data[4] = 0; m._data[8] = a; m._data[12] = 0;
		m._data[1] = 0; m._data[5] = y; m._data[9] = b; m._data[13] = 0;
		m._data[2] = 0; m._data[6] = 0; m._data[10] = c; m._data[14] = d;
		m._data[3] = 0; m._data[7] = 0; m._data[11] = - 1; m._data[15] = 0;
